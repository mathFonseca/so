...
void pingpong_init ()
{
	...
	//queue_append((queue_t**) &fila,(queue_t*) taskMain);
...
int task_switch (task_t *task)
{
	...
	current_task->cpu_time += total_sys_time - current_task->t_ultimachamada;
	task->t_ultimachamada = total_sys_time;
